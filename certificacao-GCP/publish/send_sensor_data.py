...
if __name__ == '__main__':
   ...
   #projects/certificacao-2024/topics/sandiego ...
   logging.warning('Train to conect topic {}'.format(TOPIC))
   # try:
   #    publisher.get_topic(event_type)
   #    logging.warning('Reusing pub/sub topic {}'.format(TOPIC))
   # except:
   #    publisher.create_topic(event_type)
   #    logging.warning('Creating pub/sub topic {}'.format(TOPIC))
